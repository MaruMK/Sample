    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            *************************************************************************/
            ...
            List<char> oprStk = new List<char>();                     //stack of operators
            ...
            *************************************************************************/
            bool und = true;
            char top;
            char[] testoprtr = new char[] { '+', '-', '*', '/', '$' };
            for (int i = 0; i < 5; i++)
            {
                OPRpush(oprStk, testoprtr[i]);
                dumpOPRstack(oprStk);
            }
            do
            {
                dumpOPRstack(oprStk);
                OPRpopandtest(oprStk, out top, out und);
            } while (und == false);

            Console.Write("Version 5 complete: Press any key to continue");
            Console.ReadKey();
            Console.WriteLine();
            Console.WriteLine();
        }
